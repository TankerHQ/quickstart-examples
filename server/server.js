...
app.get('/', (req, res) => {
  ...
  const appReadmePath = {
    api: path.join(__dirname, '../client/web/api-observer/README.md'),
    hello: path.join(__dirname, '../client/nodejs/hello-world/README.md'),
    notepad: path.join(__dirname, '../client/web/notepad/README.md'),
    tutorial: path.join(__dirname, '../client/web/tutorial/README.md'),
  }[app];
...
app.use('/pics', express.static(path.join(__dirname, '../client/web/api-observer/pics')));
